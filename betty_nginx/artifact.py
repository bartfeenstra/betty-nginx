...
async def generate_configuration_file(app: App, destination_file_path: Optional[Path] = None, www_directory_path: Optional[str] = None, https: Optional[bool] = None) -> None:
    kwargs = {
...
async def generate_dockerfile_file(app: App, destination_file_path: Optional[Path] = None) -> None:
    if destination_file_path is None:
